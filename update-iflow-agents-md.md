...
You are going to help me update the **hierarchical agents.md system** for this codebase. This is critical for AI coding agents to work efficiently with minimal token usage.
...
update the **lightweight root agents.md** (~100-200 lines max) that includes:
...
For EACH major package/directory identified in Phase 1, update the **detailed agents.md** that includes:
